...
CREATE TRIGGER `trigger1` BEFORE INSERT ON `table2`
...
CREATE OR REPLACE DEFINER = the_owner SQL SECURITY DEFINER VIEW `view`
  AS SELECT * FROM table2;
SQL;
    
    $this->common($expected);
  }
...
SQL;
  ...
  private function common($expected) {
    $dbs = new SimpleXMLElement($this->xml);
