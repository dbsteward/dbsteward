...
class oracle10g_schema extends sql99_schema {
  ...
  public function get_creation_sql($node_schema) {
    if (strcasecmp('dbo', $node_schema['name']) == 0) {
      ...
      $schema_name = oracle10g::get_quoted_name($node_schema['name'], dbsteward::$quote_schema_names);
  ...
  public function get_drop_sql($node_schema) {
    $ddl = "DROP SCHEMA " . oracle10g::get_quoted_name($node_schema['name'], dbsteward::$quote_schema_names) . ";\n";
    return $ddl;
  }
