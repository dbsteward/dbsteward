...
class mssql10_table extends sql99_table {
  ...
  public function get_drop_sql($node_schema, $node_table) {
    ...
    return "DROP TABLE " . mssql10::get_quoted_schema_name($node_schema['name']) . '.' . mssql10::get_quoted_table_name($node_table['name']) . ";";
  }
