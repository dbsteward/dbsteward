 ...
 * @version $Id: oracle10g_column.php 2267 2012-01-09 19:50:46Z nkiraly $
 */
...
class oracle10g_column extends pgsql8_column {
  ...
  public function get_full_definition($db_doc, $node_schema, $node_table, $node_column, $add_defaults, $include_null_definition = true) {
    ...
    $definition = oracle10g_diff::get_quoted_name($node_column['name'], dbsteward::$quote_column_names) . ' ' . $column_type;
